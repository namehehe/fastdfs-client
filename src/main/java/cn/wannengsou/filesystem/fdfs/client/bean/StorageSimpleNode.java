package cn.wannengsou.filesystem.fdfs.client.bean;
 ...
 */
public class StorageSimpleNode implements Serializable {
     ...
     */
    public StorageSimpleNode(String ip, int port, byte storeIndex) {
        super();
        this.ip = ip;
        this.port = port;

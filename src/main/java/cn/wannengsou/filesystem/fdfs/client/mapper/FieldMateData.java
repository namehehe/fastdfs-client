package cn.wannengsou.filesystem.fdfs.client.mapper;
...
public class FieldMateData {
    ...
    private byte[] getDynamicFieldByteValue(Object value, Charset charset) {
        switch (dynamicFieldType) {
            ...
            // 如果是文件matedata
            case matedata:
                return BytesUtil.map2byte((Map<String, String>) value, charset);
            default:
                return BytesUtil.objString2Byte((String) value, charset);
        }
    }
    ...
    int getDynamicFieldByteSize(Object bean, Charset charset)
        ...
        switch (dynamicFieldType) {
            ...
            // 如果是文件matedata
            case matedata:
                return BytesUtil.map2byte((Map<String, String>) value, charset).length;
            default:
